...
import { compareColors, stringToColor } from '@iconizza/utils/lib/colors'
import type { IconSet } from '@iconizza/tools'
import {
   deOptimisePaths,
   importDirectory,
   parseColors,
...
import type { CustomIconLoader } from '@iconizza/utils/lib/loader/types'
