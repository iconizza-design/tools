...
import { iconToSVG, trimSVG } from '@iconizza/utils'
...
// Re-export types
export type { IconizzaIconCustomisations, IconizzaIcon }
...
export class SVG {
    ...
    * Get SVG as string
    */
   toString(customisations?: IconizzaIconCustomisations): string {
    ...
    */
   toMinifiedString(customisations?: IconizzaIconCustomisations): string {
   ...
   /**
    * Get icon as IconizzaIcon
    */
   getIcon(): IconizzaIcon {
   ...
   load(content: string): void {
      ...
      if (viewBox !== void 0) {
         ...
         this.viewBox = {
            left: Number.parseFloat(list[0]),
            top: Number.parseFloat(list[1]),
            width: Number.parseFloat(list[2]),
            height: Number.parseFloat(list[3]),
         }
      }
      else {
