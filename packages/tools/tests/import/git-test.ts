...
import type { DownloadGitRepoResult } from '../../lib/download/git'
import { downloadGitRepo } from '../../lib/download/git'
...
const testRepo = 'https://github.com/nyxb/package-test.git'
